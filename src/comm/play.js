...
const getBasicModel = (i) => {
  ...
  return {
    _id: getRandomID(),
    name: '普通的剧本',
    src: 'https://cdn.jsdelivr.net/gh/DailyLearningJS/script-game@6.0/src/res/play/' + i +'.jpg',
    ...
    brief: '剧本杀线下助手欢迎每一名新侦探的到来, 为了更好的体验游..',
...
const getBasicShopModel = (i) => {
  ...
  return {
    _id: getRandomID(),
    name: '桌游俱乐部',
    src: 'https://cdn.jsdelivr.net/gh/DailyLearningJS/script-game@6.0/src/res/shop/' + i +'.jpg',
    stars: +((Math.random() * 5).toFixed(0)) || 1,
    // 剧本本身的标签
    tags,
    // 姥爷们对剧本印象的标签
    ...
    brief: '剧本杀线下助手欢迎每一名新侦探的到来, 为了更好的体验游戏...',
    intro: '剧本杀线下助手欢迎每一名新侦探的到来, 为了更好的体验游戏, 希望所有玩家都可以先体验一遍新手教程, 通关完成之后会给你颁发奖章, 以证明你是一个合格的侦探~ 剧本杀线下助手欢迎每一名新侦探的到来, 为了更好的体验游戏, 希望所有玩家都可以先体验一遍新手教程, 通关完成之后会给你颁发奖章, 以证明你是一个合格的侦探~',
    roles: [
      {
        name: '杀人凶手',
...
export function getRandomBasicShopData(i) {
  return getBasicShopModel(i)
}
