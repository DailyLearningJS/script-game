...
const getBasicModel = (i) => {
  ...
  return {
    _id: getRandomID(),
    name: '普通的剧本',
    src: 'https://cdn.jsdelivr.net/gh/DailyLearningJS/script-game@5.0/src/res/play/' + i +'.jpg',
...
const getBasicShopModel = (i) => {
  ...
  return {
    _id: getRandomID(),
    name: '桌游俱乐部',
    src: 'https://cdn.jsdelivr.net/gh/DailyLearningJS/script-game@5.0/src/res/shop/' + i +'.jpg',
    stars: +((Math.random() * 5).toFixed(0)) || 1,
    // 剧本本身的标签
    tags,
    // 姥爷们对剧本印象的标签
