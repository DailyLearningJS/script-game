    ...
    return (
            ...
            play.roles.map((r, i) => {
              ...
              return (
                <View className='info-item' key={r}>
                  <View className='left'>
                    <Image src={'https://cdn.jsdelivr.net/gh/DailyLearningJS/script-game@6.0/src/res/user/' + (i + 1) + '.png'} />
                  </View>
                  <View class='right'>
      ...
      <View className='main'>
          <View className='main-title'>
            <View className='left'>
              <Image className='img' src='https://cdn.jsdelivr.net/gh/DailyLearningJS/script-game@6.0/src/res/user/7.png'></Image>
