    ...
    return (
      <View className='page'>
        ...
        <View className="wxfeature-footer">
          <Image src="https://cdn.jsdelivr.net/gh/DailyLearningJS/script-game@3.0/src/res/wxfeature/picture.png"></Image>
          <Button className='camera-button' plain onClick={this.takePhoto}>拍照</Button>
          <Image src="https://cdn.jsdelivr.net/gh/DailyLearningJS/script-game@3.0/src/res/wxfeature/rotate.png"></Image>
        </View>
      </View>
    )
  }
