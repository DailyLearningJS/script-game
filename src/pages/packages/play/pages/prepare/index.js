            ...
            players.map((player, i) => {
              return (
                <View className='player-con fcc-c' key={player.name}>
                  <Image className='role-icon' src={'https://cdn.jsdelivr.net/gh/DailyLearningJS/script-game@2.0/src/res/user/' + (i + 1) + '.png'} mode='aspectFill' />
              ...
              return (
                <View className='w100' key={r.name + idx}>
                  <CBlock disabled={isReady}>
                    ...
                    >
                      <Image className='role-avatar' src={'https://cdn.jsdelivr.net/gh/DailyLearningJS/script-game@2.0/src/res/user/' + (idx + 1) + '.png'} mode='aspectFill' />
                              ...
                              roleSelectedRec[r.name].map((player, pidx) => {
                                return (
                                  <View key={player.name}>
                                    <Image className={'player-icon ' + (pidx === 0 ? 'first' : '')} src={'https://cdn.jsdelivr.net/gh/DailyLearningJS/script-game@2.0/src/res/user/' + (pidx + 1) + '.png'} mode='aspectFill' />
                                    {
