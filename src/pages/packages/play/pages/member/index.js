    ...
    return (
      <View className='page'>
        <View className='filter'>
          <View>
            会员等级<Image src="https://cdn.jsdelivr.net/gh/DailyLearningJS/script-game@6.0/src/res/wxfeature/sort.svg"></Image>
          </View>
          <View>
            注册时间<Image src="https://cdn.jsdelivr.net/gh/DailyLearningJS/script-game@6.0/src/res/wxfeature/sort.svg"></Image>
          </View>
          <View>
            活跃度<Image src="https://cdn.jsdelivr.net/gh/DailyLearningJS/script-game@6.0/src/res/wxfeature/sort.svg"></Image>
          </View>
        </View> 
            ...
            this.state.playerList.map((item, index) => {
              return (
                <View className="userlist-item" key={index}>
                  <Image src={'https://cdn.jsdelivr.net/gh/DailyLearningJS/script-game@6.0/src/res/user/'+ (index + 1) +'.png'} mode='aspectFill' />
