  ...
  render () {
    ...
    return (
      <View className='page with-tabbar'>
        ...
        <View className='tips'>
          <Text>约本广场</Text>
          <Image src='https://cdn.jsdelivr.net/gh/DailyLearningJS/script-game@6.0/src/res/sound-filling-fill.png' style='width: 16px;height:16px;margin:0 5px;' />
          <Swiper
          ...
          <CBlock>
            <View className='room room-big' onClick={this.goBookFamily}>
              <View className='max fcc'>
                <Image src='https://cdn.jsdelivr.net/gh/DailyLearningJS/script-game@6.0/src/res/feature/feature1.png' mode='scaleToFill' ></Image>
          ...
          <View className='con fsbc-c h100'>
            <CBlock>
              <View className='room room-small'>
                <View className='max fcc'>
                  <Image src='https://cdn.jsdelivr.net/gh/DailyLearningJS/script-game@6.0/src/res/feature/feature2.png' mode='scaleToFill' ></Image>
                  <View className='tool-tip'>
            ...
            <CBlock>
              <View className='room room-small' onClick={this.goBook}>
                <View className='max fcc'>
                  <Image src='https://cdn.jsdelivr.net/gh/DailyLearningJS/script-game@6.0/src/res/feature/feature3.png' mode='scaleToFill' ></Image>
                  <View className='tool-tip'>
